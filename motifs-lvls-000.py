...
# W edge inequalities
def w_inequalities(a_start,a_end,b_start,b_end):
    for i in range(a_start + 1, a_end):
        inequality = ""    
        for j in range(b_start + 1, b_end):
            if MOTIF[i-1] + MOTIF[j-1] not in CP_list:
...
w_inequalities(a_start,a_end,b_start,b_end)
w_inequalities(b_start,b_end,a_start,a_end)
        
# H edge inequalities
def  h_inequalities(a_start,a_end,b_start,b_end):
    for i in range(a_start + 1, a_end):
        inequality = ""    
        for j in range(b_start + 1, b_end):        
...
h_inequalities(a_start,a_end,b_start,b_end)
h_inequalities(b_start,b_end,a_start,a_end)

# S edge inequalities
def s_inequalities(a_start,a_end,b_start,b_end):
    for i in range(a_start + 1, a_end):
        inequality = ""    
        for j in range(b_start + 1, b_end):
...
s_inequalities(a_start,a_end,b_start,b_end)
s_inequalities(b_start,b_end,a_start,a_end)
