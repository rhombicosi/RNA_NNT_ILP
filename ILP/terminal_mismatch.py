...
mismatch = np.array([[[-0.3, -0.5, -0.3, -0.5],[-0.1, -0.2, -0.1, -0.2],[-1.2, -0.5, -1.1, -0.5],[-0.1, -0.3, -0.1, -1.2]],
                     [[-1.5, -1.5, -1.4, -1.5],[-1.0, -1.1, -1.0, -0.8],[-2.3, -1.5, -2.4, -1.5],[-1.0, -1.4, -1.0, -2.1]],
                     [[-1.1, -1.5, -1.3, -1.5],[-1.1, -0.7, -1.1, -0.5],[-2.5, -1.5, -2.2, -1.5],[-1.1, -1.0, -1.1, -1.6]],
                     [[0.2, -0.5, -0.3, -0.5],[-0.1, -0.2, -0.1, -0.2],[-1.0, -0.5, -1.1, -0.5],[-0.1, -0.3, -0.1, -1.0]],
                     [[-0.5, -0.3, -0.5, -0.3],[-0.2, -0.1, -0.2, -0.0],[-1.5, -0.3, -1.5, -0.3],[-0.2, -0.1, -0.2, -0.9]],
                     [[-0.5, -0.3, -0.6, -0.3],[-0.2, -0.1, -0.2, -0.0],[-0.9, -0.3, -1.1, -0.3],[-0.2, -0.1, -0.2, -0.9]]])
